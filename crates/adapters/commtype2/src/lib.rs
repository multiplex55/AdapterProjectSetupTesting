...
pub enum CommType2InfraError { HardwarePathUnimplemented }

pub struct CommType2Adapter;
impl CommType2Adapter { pub fn new() -> Self { Self } }
impl Default for CommType2Adapter { fn default() -> Self { Self::new() } }
